/*
    HDC
*/
Ext.define('DIRECTO.LIB.operation.appMain', {
    extend: 'DIRECTO.LIB.base.operationPanel',
	requires: 'DIRECTO.LIB.base.operationPanel',

    alias: 'widget.appMain',

    //Objeto que contiene las ventanas de las operaciones llamadas
    operationsWindows: null,
